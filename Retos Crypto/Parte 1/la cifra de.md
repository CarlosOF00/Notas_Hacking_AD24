...
```
- Este texto lo introduje en https://www.dcode.fr/identificador-cifrado, para identificar el tipo de cifrado.
- Ahora que identifique el tipo de cifrado, utilice esta pagina (https://www.guballa.de/vigenere-solver) para descifrar el texto.
```bash
...
## Referencias 
https://play.picoctf.org/practice/challenge/3?category=2&difficulty=2&page=1&search=LA%20CI
