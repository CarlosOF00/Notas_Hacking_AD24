## Descripción 
Can you figure out how this program works to get the flag?Connect to the program with netcat:`$ nc saturn.picoctf.net 61356`The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/521/picker-II.py).
...
┌──(kali㉿kali)-[~/retosReverse/picker2]
└─$ wget https://artifacts.picoctf.net/c/521/picker-II.py
--2024-10-28 19:41:49--  https://artifacts.picoctf.net/c/521/picker-II.py
...
2024-10-28 19:41:49 (47.7 MB/s) - ‘picker-II.py’ saved [3510/3510]
