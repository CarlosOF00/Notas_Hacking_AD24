...
## Solución
```bash
carlosof-picoctf@webshell:~$ ssh ctf-player@venus.picoctf.net -p 60889
...
Last login: Sun Sep 15 06:55:52 2024 from 127.0.0.1
ctf-player@pico-chall$ ls -la
total 16
drwxr-xr-x 1 ctf-player ctf-player 4096 Mar 16  2021 .
drwxr-xr-x 1 ctf-player ctf-player 4096 Sep 15 07:03 ..
