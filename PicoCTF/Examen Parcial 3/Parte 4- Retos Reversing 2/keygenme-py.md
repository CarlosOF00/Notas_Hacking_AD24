...
┌──(kali㉿kali)-[~/Parcial3/keygenme-py]
└─$ wget https://mercury.picoctf.net/static/fb75b48f9214cf992a2199b5785564e7/keygenme-trial.py
--2024-11-17 15:19:55--  https://mercury.picoctf.net/static/fb75b48f9214cf992a2199b5785564e7/keygenme-trial.py
Resolving mercury.picoctf.net (mercury.picoctf.net)... 18.189.209.142
Connecting to mercury.picoctf.net (mercury.picoctf.net)|18.189.209.142|:443... connected.
HTTP request sent, awaiting response... 200 OK
Length: 10198 (10.0K) [application/octet-stream]
Saving to: ‘keygenme-trial.py’

keygenme-trial.py                         100%[===================================================================================>]   9.96K  --.-KB/s    in 0s      

2024-11-17 15:19:55 (149 MB/s) - ‘keygenme-trial.py’ saved [10198/10198]
...
Codigo Python: solucion.py
```bash
import hashlib

# Partes estáticas de la clave (fijas)
clave_estatica1 = "picoCTF{1n_7h3_|<3y_of_"
clave_estatica2 = "}"

# Parte dinámica de la clave (inicializada con valores de prueba)
clave_dinamica1 = "xxxxxxxx"

# Calcular el hash SHA-256 de "FREEMAN"
temp = hashlib.sha256(b"FREEMAN").hexdigest()

# Obtener los caracteres específicos del hash para formar la parte dinámica de la clave
clave_dinamica1 = temp[4] + temp[5] + temp[3] + temp[6] + temp[2] + temp[7] + temp[1] + temp[8]

# Combinar las partes estáticas y dinámicas para formar la clave completa
clave_completa = clave_estatica1 + clave_dinamica1 + clave_estatica2

# Imprimir la clave completa
print(clave_completa)
```
...
## Notas Adicionales
- Para mayor comodidad, usar un IDE como lo es Visual Studio Code.
## Referencias 
